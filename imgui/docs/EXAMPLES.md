...
INCLUDES = -I$(INCL_FOLDER) -I$(IMGUI_FOLDER) -I$(BACKEND_FOLDER)
...
clean:
	rm -f $(OBJS) $(EXEC)_(You may browse this at https://github.com/ocornut/imgui/blob/master/docs/EXAMPLES.md or view this file with any Markdown viewer)_
